...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-secondary flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-2xl border border-light-border shadow-sm p-8 flex flex-col items-center text-center">
        <div className="mb-6">
        ...
        <div className="w-full space-y-3 flex flex-col">
          ...
          <Link href="/login">
            <button className="w-full py-3 bg-white text-dark border border-light-border rounded-full font-medium hover:bg-secondary transition-all transform hover:scale-105">
              Sign In
            </button>
          </Link>
        </div>
