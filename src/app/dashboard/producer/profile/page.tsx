...
export default function ProducerProfilePage() {
  ...
  return (
    <DashboardLayout>
      <h1 className="text-2xl font-bold mb-6">Producer Profile</h1>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl border border-light-border">
          ...
          <p className="text-xs text-light-muted">Business Name</p>
          <input value={businessName} onChange={(e) => setBusinessName(e.target.value)} className="w-full p-3 border rounded-lg mb-3" />
